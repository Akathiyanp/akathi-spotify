...
const playlists = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=300&q=80"
  },
  {
    title: "Chill Hits",
    description: "Kick back to the best new and recent chill hits.",
    imageUrl: "https://images.unsplash.com/photo-1445985543470-41fba5c3144a?w=300&q=80"
  },
  {
    title: "Viva Latino",
    description: "Today's top Latin hits, elevando nuestra música.",
    imageUrl: "https://images.unsplash.com/photo-1471478331149-c72f17e33c73?w=300&q=80"
  }
];
  ...
  return (
    <div className="flex-1 bg-gradient-to-b from-[#1f1f1f] to-[#121212] overflow-auto pb-36 md:pb-24">
      <div className="p-4 md:p-8">
        <h1 className="text-xl md:text-2xl font-bold text-white mb-6">Good afternoon</h1>
          ...
          {playlists.slice(0, 6).map((playlist, index) => (
            ...
            >
              ...
              <button className="h-10 w-10 md:h-12 md:w-12 bg-green-500 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 mr-2 md:mr-4 hover:scale-105 transition-all">
                <Play className="h-5 w-5 md:h-6 md:w-6 text-black" fill="black" />
              </button>
            </div>
          ))}
        </div>
        ...
        <h2 className="text-xl md:text-2xl font-bold text-white mb-6">Made for you</h2>
